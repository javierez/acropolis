...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `${baseUrl}/propiedades/${unwrappedParams.id}`,
    },
    openGraph: {
      title: `${property.title} | ${companyName}`,
      description: property.description || `Propiedad en ${property.city}`,
...
export default async function PropertyPage({ params }: PropertyPageProps) {
  ...
  // Fetch watermark configuration and account info
    ...
    <>
      <BreadcrumbJsonLd
        ...
        items={[
          ...
          { name: cleanTitle(property.title), href: `/propiedades/${property.listingId}` },
        ]}
      />
      <PropertyJsonLd
        property={property}
