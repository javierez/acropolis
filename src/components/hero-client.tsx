    ...
    <section className="relative mb-8 overflow-hidden sm:mb-12 md:mb-[60px] lg:mb-[70px]">
      ...
      <div className="container pb-20 pt-6 sm:pb-32 sm:pt-10 md:pb-40 md:pt-8 lg:pb-48 lg:pt-12">
        <div className="max-w-3xl space-y-4 px-4 sm:ml-8 sm:space-y-5 md:ml-12 lg:mx-auto lg:px-4">
          ...
          >
            <Link href="/venta-propiedades/todas-ubicaciones" className="w-full sm:w-auto">
              <Button
                size="lg"
            ...
            <Link href="#contact" className="w-full sm:w-auto">
              <Button
                size="lg"
                className="w-full min-w-0 !bg-black/80 !text-white hover:!bg-gray-900/90 hover:!text-white hover:scale-105 active:scale-95 transition-transform sm:w-auto"
              >
                {contactButton}
              </Button>
            </Link>
